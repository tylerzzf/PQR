...
n=T=40
tem.44 = onebreak.sim.func(n,T,p,taus,cpt.num,nrep,eps,cpt.eps,step.max)
...
n=40 
T=80
tem.48 = onebreak.sim.func(n,T,p,taus,cpt.num,nrep,eps,cpt.eps,step.max)
...
n=80
T=40
tem.84 = onebreak.sim.func(n,T,p,taus,cpt.num,nrep,eps,cpt.eps,step.max)
...
n=80
T=80
tem.88 = onebreak.sim.func(n,T,p,taus,cpt.num,nrep,eps,cpt.eps,step.max)
